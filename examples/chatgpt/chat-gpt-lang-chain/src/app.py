...
<img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1" />
    ...
    inputs = [openai_api_key_textbox, message, history_state, chain_state, trace_chain_state,
    ...
    message.submit(chat, inputs=inputs ,
    ...
    #openai_api_key_textbox.set_event_trigger()
    #set_openai_api_key()
