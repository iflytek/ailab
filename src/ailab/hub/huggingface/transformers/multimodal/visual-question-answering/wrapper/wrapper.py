...
class UserRequest(object):
    ...
    input2 = StringBodyField(key=input2_key, value='{"question":"What is it?", "top_k":5}'.encode("utf-8"))
...
class Wrapper(WrapperBase):
    ...
    def wrapperOnceExec(self, params: {}, reqData: DataListCls) -> Response:
        ...
        input_json = json.loads(reqData.get(input2_key).data.decode("utf-8"))
        question = input_json["question"]
        top_k = input_json["top_k"]
        result = self.pipe(input_image, question, top_k=top_k)
