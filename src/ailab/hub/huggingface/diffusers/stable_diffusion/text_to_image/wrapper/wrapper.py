...
task = "stable-diffusion-text-to-image"
...
class Wrapper(WrapperBase):
    ...
    def wrapperInit(self, config: {}) -> int:
        ...
        self.pipe = StableDiffusionPipeline.from_pretrained(model, torch_dtype=torch.float16).to("cuda")
    ...
    def wrapperOnceExec(self, params: {}, reqData: DataListCls) -> Response:
        ...
        result = self.pipe(input_text).images[0]
