...
task = "cycle-diffusion-pipeline"
source_prompt = "An astronaut riding a horse"
prompt = "An astronaut riding an elephant"

# 定义模型的超参数和输入参数
class UserRequest(object):
    input1 = ImageBodyField(key="image", path='./horse.png')
...
class Wrapper(WrapperBase):
    ...
    def wrapperInit(self, config: {}) -> int:
        ...
        self.pipe = CycleDiffusionPipeline.from_pretrained(model, scheduler=scheduler).to("cuda")
    ...
    def wrapperOnceExec(self, params: {}, reqData: DataListCls) -> Response:
        ...
        result.save("./horse_to_elephant.png", format="PNG")
